...
fs.readFile(path, 'utf8', (err, jsonString)=> {
    ...
    data.products.forEach((prod, i) => {
        prod.id = Math.ceil(Math.random()*2000000)
        // prod.category.replace(, 'Clothing')
        // prod.breadCrumbs = prod.breadCrumbs.replace('Ready to Wear', 'Clothing')
        // if (prod.category==='clothing'){
        //     prod.category = 'Clothing'
        // }
        // prod.mrp = Math.ceil(Math.random()*5000)
        // prod.discount = Math.ceil(Math.random()*6)*10
        
        // delete prod.price_url

        //------------PUT IMAGE URLS TOGETHER-----------
        // let images = []
        ...
        // delete prod.image
        //---------------------------------------------------
        // let [department, category, subCategory, title] = prod.breadCrumbs.split('\n')
